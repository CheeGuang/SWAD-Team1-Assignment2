...
namespace SWAD_IT02_Team1_Assignment2
{
    ...
    internal class Program
    {
        ...
        public static void AddDummyData()
        {
            ...
            dummyCarOwner = new CarOwner(1, "Benjamin Lau", "s10258772@connect.np.edu.sg", "0987654321", "1985-02-02", 100.0m, 500.0m);
            dummyRenter = new Renter(1, "Raeanne Zou", "raeannezou@gmail.com", "1122334455", "1992-03-03", "DL123456", 50.0m, 200.0m, true, true);
