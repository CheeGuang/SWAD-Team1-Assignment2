...
namespace SWAD_IT02_Team1_Assignment2
{
    internal class Program
    {
        ...
        public static void AddDummyData()
        {
            ...
            dummyCarOwner = new CarOwner(1, "Jane Doe", "jane.doe@example.com", "0987654321", "1985-02-02", 100.0m, 500.0m);
            dummyRenter = new Renter(1, "Jack Smith", "jack.smith@example.com", "1122334455", "1992-03-03", "DL123456", 50.0m, 200.0m, true, true);
            dummyICarAdmin = new ICarAdmin(1, "Emily Johnson", "emily.johnson@example.com", "6677889900", "1988-04-04", true);

            // Create instance of Car
            Car dummyCar = new Car(1, "Toyota", "Camry", 2020, 15000.0m, 50.0m, "SGX1234A", true, true);
            ...
            returnLocations = new List<ReturnLocation>
        {
            ...
            Card card1 = new Card(1, "4111111111111111", "John Doe", new DateTime(2025, 12, 31), "Visa", "DBS", wallet1);

            // Create instances of Payment
            Payment payment1 = new Payment(1, 100.00m, "Credit Card", DateTime.Now, card1);

            // Create instances of Booking
            Booking booking1 = new Booking(1, dummyRenter, dummyCar, new DateTime(2024, 08, 01, 9, 0, 0), new DateTime(2024, 08, 02, 9, 0, 0), 100.00m, payment1, pickupLocations[0], returnLocations[0]);
